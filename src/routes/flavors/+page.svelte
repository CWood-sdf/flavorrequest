...
<table class="table-auto rounded w-full my-4">
	<thead class=" bg-slate-50 dark:bg-slate-700">
		<tr class="text-left">
			...
			<th class=" p-3 border border-slate-600">Short Description</th>
	...
	<tbody class=" bg-slate-100 dark:bg-slate-800">
		{#each data.data as item}
			<tr class="">
				...
				<td class=" px-3 py-2 border border-slate-700">
					<a href="flavors/{item.id}/edit" class="underline text-blue-400">Edit</a> |
					<a href="flavors/{item.id}" class="underline text-blue-400">View</a>
					|
					<a href="flavors/{item.id}/delete" class="underline text-blue-400">Delete</a>
				</td>
				<!-- {/if} -->
			</tr>
		{/each}
...
<a href="flavors/new" class="underline text-blue-400">Add new flavor</a>
